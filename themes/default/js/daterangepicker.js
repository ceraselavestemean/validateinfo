                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +                      
                      '<input class="input-mini" type="hidden" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +                      
                      '<input class="input-mini" type="hidden" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
